...
print("Generating deliveries.csv for the routing demo...")
sample_df = df.sample(11, random_state=42)
...
print(f"Success! Created demo routing dataset at {delivery_out_file}")
